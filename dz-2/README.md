...
```
- индекс поиска бронирований на определенную дату (необходимо для запроса "Поиск доступных ТС на определенную дату"), композитный;
- индекс поиска по статусу бронирования (необязателен, но может ускорить выборку по запросам, например в рамках запроса "Поиск доступных ТС на определенную дату"), простой;
